    ...
    (print x y z "\n"))))"#;
        ...
        assert_eq!(
            ...
            vec![
                ...
                // SetLocal(RuntimeMetadata::new(1, "y", 25..35)),
                // GetLocal(RuntimeMetadata::new(1, "y", 25..35)),
                // SetFree(RuntimeMetadata::new(1, "y", 25..35)),
                // Push(Box::new(F64(3.0))),
                // SetLocal(RuntimeMetadata::new(2, "z", 40..50)),
                // Push(Box::new(String(Box::new("\n".to_string())))),
                // GetLocal(RuntimeMetadata::new(2, "z", 61..63)),
                // GetLocal(RuntimeMetadata::new(1, "y", 59..61)),
                // GetLocal(RuntimeMetadata::new(0, "x", 57..59)),
